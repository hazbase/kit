/* Minimal ABI for TimelockController used by the SDK */
/* eslint-disable prettier/prettier */
export const TimelockController = {
  contractType: 'TimelockController',
  initArgs: 'initialize(uint256 minDelay, address[] memory proposers, address[] memory executors, address admin)',
  abi: [
    {
      "inputs": [],
